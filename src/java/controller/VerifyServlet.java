...
public class VerifyServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (Connection conn = ConnectDB.getInstance().openConnection()) {
            String sql = "SELECT * FROM Users WHERE username = ? AND verification_code = ? AND is_verified = 0";
            ...
            if (rs.next()) {
                sql = "UPDATE Users SET is_verified = 1 WHERE username = ? AND verification_code = ?";
