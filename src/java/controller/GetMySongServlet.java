 ...
 * @author pc
 */
public class GetMySongServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MySongServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MySongServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    """;
            ...
            ps.setInt(2, Integer.parseInt(userId)); // Lọc theo user_id (bài hát do user upload)
            ...
            while (rs.next()) {
                ...
                song.put("liked", rs.getInt("liked") == 1); // Kiểm tra xem user có tym hay không
